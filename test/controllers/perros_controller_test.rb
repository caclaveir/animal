...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference('Perro.count') do
      post perros_url, params: { perro: { direccion: @perro.direccion, edad: @perro.edad, localidad: @perro.localidad, nombre: @perro.nombre, vive: @perro.vive } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { direccion: @perro.direccion, edad: @perro.edad, localidad: @perro.localidad, nombre: @perro.nombre, vive: @perro.vive } }
